...
VERSION=v1.34 # the following gets the latest version, version 1.35 does not work. $(curl https://api.github.com/repos/pftf/RPi4/releases/latest -s | jq .name -r)  # use latest one from https://github.com/pftf/RPi4/releases
